...
(global-set-key "\C-d" 'delete-word)
...
;; auto ending curly brace or paren
...
;; set key bindings for multiple cursors extension
...
(add-to-list 'webjump-sites
		...
		""]))
(add-to-list 'webjump-sites
	    '("Bitstarter" . "http://jessewar-bitstarter-s-mooc.herokuapp.com"))	     
